...
import homeBg from '../BackgroundImgs/fff.jpg'


function Space() {
  return (
        <div className='space'>
            <div className='section1' style={{backgroundImage: `url(${homeBg})`}}>
              <div>
            ...
            <div className='section2' style={{backgroundImage: `url(${homeBg})`}}>
               <img src={Explore}/> 
            </div>
        </div>
  )
